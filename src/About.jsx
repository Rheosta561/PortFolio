...
function About() {
  return (
    <div className='bg-zinc-100 h-fit pb-4 flex-col dark:bg-zinc-950'>
        ...
        <div className='pl-4 pt-3 font-bold dark:text-zinc-400' >Curriculum Vitae     <span> <a href="https://drive.google.com/file/d/1BblDPe-3tIQmGP_QOiu4NbTCUzN-aCd_/view?usp=sharing" className='text-blue-800 text-sm'>Link</a></span></div>
    </div>
  )
}
