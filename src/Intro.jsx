  ...
  return (
    <>
      ...
      <div className="h-screen relative flex flex-col items-center justify-center p-4 dark:bg-[url('./bg3.jpg')] bg-zinc-50 bg-cover bg-center">
        ...
        <div className="text-lg dark:text-gray-400 text-zinc-900">Hi there, Welcome to my portfolio</div>
        <div className="dark:text-gray-500 text-zinc-600 text-sm">I’m delighted to have you here!</div>
        <br />
